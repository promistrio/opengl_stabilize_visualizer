...
SDL_GL_LoadTexture(SDL_Surface * surface, GLfloat * texcoord)
{
    ...
    glTexImage2D(GL_TEXTURE_2D,
                 0,
                 GL_INTENSITY8, w, h, 0, GL_RGBA, GL_UNSIGNED_BYTE, image->pixels);
...
void yuvGL::init()
{
    ...
    this->window = SDL_CreateWindow( "Shader Demo", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1920, 1080, SDL_WINDOW_OPENGL );
    if ( !window ) {
    ...
    this->surface = SDL_LoadBMP("icon2.bmp");
    if ( ! surface ) {
    ...
    this->texture = SDL_GL_LoadTexture(surface, texcoords);
...
void yuvGL::refresh()
{
    DrawGLScene(this->window, this->texture, this->texcoords);
